...
//reference: http://www.coderzheaven.com/2013/03/13/customize-force-close-dialog-android/
...
public class UnCaughtException implements UncaughtExceptionHandler {
    ...
    public UnCaughtException(Context ctx) {
        ...
        mLogFile = LogManager.getInstance(context);
    }
    ...
    /**
     * This method calls alert dialog when application crashed!
     */
    public void saveErrorReport(final StringBuilder errorContent) {
            ...
            public void run() {
                ...
                builder.setPositiveButton("Report",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                    int which) {
                                //old codes to send the report via email
                            	...
                            	//save the report
                            	mLogFile.log(errorContent.toString(), Constants.LOG_FILE_TYPE[0]);
